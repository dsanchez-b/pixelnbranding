...
export function UserProvider({ children }) {
  ...
  const [addresses, setAddresses] = useState([
    { id: uuidv4(), label: 'Casa', street: 'Av. Siempre Viva 742', city: 'Springfield', state: 'SP', zip: '12345' }
  ]);

  // Métodos de pago (array con id único)
  const [paymentMethods, setPaymentMethods] = useState([
    { id: uuidv4(), cardHolder: 'Juan Pérez', cardNumber: '1234123412341234', expirationDate: '12/25', cvv: '123' }
  ]);
